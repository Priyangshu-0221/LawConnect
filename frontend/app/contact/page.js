  ...
  return (
    <>
      ...
      <div className="w-full sm:flex sm:flex-col gap-4 my-14 px-5 md:flex md:flex-row  sm:w-screen justify-between items-center">
        ...
        <div className="w-[100%] text-left h-[50%] ">
          <div>
            ...
            <p className="mb-4">
              Tel: (+91) 11111-11111 Email: mondalpriyangshu@gmail.com{"   "}
            </p>
          </div>
          <div>
            <h1 className="text-xl font-semibold">Carrers at BookMyDoc</h1>
            <br />
            <p className="mb-4 text-lg">
              Learn more about our teams and job openings.
            </p>
            <button className="bg-blue-400 h-20 text-xl text-white font-semibold items rounded-lg w-50">
              Explore Jobs..
            </button>
          </div>
        </div>
